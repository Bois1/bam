...
<body>
	<div class="container" style="margin-top: 50px">
		<div class="row">
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-header bg-success text-white font-weight-bold" style="text-align: center; font-size: 20px">Registration Form</div>
					<div class="card-body bg-light">
						<form method="POST" id="registration_form">
							...
							<div class="form-group">
								<label style="font-weight: bold">Email <Address></Address></label>
								<input type="email" name="email" id="email" placeholder="Enter Email Address.." class="form-control" require />
								<span id="error_email" class="text-danger"></span>
							</div>
							<div class="form-group">
								<label style="font-weight: bold">Department</label>
								<!-- <select type="text" name="dept" id="dept" class="form-control" require></select> -->
								<input type="text" name="dept" id="dept" placeholder="Enter department.." class="form-control" require />
							...
							<div id="controls" class="form-group col text-center" style="margin-top: 20px; margin-bottom: 0px">
								...
								<button id="createEnrollmentButton" type="button" class="btn btn-success btn-block" onclick="beginEnrollment()">Submit</button>
							</div>
