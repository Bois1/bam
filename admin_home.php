...
<body>
	<div class="jumbotron-small text-center" style="margin-top: 20px; margin-bottom: 20px">
		<h2 class="text-warning">Biometric Attendance System</h2>
	</div>
	<div class="container" style="margin-top: 50px">
		<div class="row">
			...
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<button type="button" class="btn btn-success float-right btn-sm" style="margin-top: 10px; margin-bottom: 50px; font-weight: bold" onClick="window.location.href='logout.php'">Log Out</button>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<div class="card">
					<div class="card-header bg-success text-white font-weight-bold" style="text-align: center; font-size: 20px">Admin Dashboard</div>
